...
neither sees it nor charges for it. Tables in `geminis/predicado/RESULTADOS-EN.md`.
...
> sources in `test1-transicion/RESULTADOS-EN.md`.
>
...
> data in `test2-interprete/RESULTADOS-EN.md`.
...
> `test4-ventana-k/RESULTADOS-EN.md`.
>
...
written before the first line of code, in `geminis/predicado/CRITERIOS-EN.md`, and seven of them are
...
> 67 to 15 transactions. Tables and method in `geminis/predicado/RESULTADOS-EN.md`.
>
