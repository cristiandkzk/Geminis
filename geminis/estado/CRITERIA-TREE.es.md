...
[English](CRITERIA-TREE.md) · **Español**
...
Y el diseño del árbol ya estaba decidido y medido (`presupuesto-nodo/RESULTS.es.md`, 18/8/2026):
...
`presupuesto-nodo/RESULTS.es.md` afirma **32 B por entrada con `d=1`, 1,0 B con `d=6` y 0,125 B
con `d=9`**.
