...
And the tree's design was already decided and measured (`presupuesto-nodo/RESULTADOS-EN.md`, 18/8/2026):
...
`presupuesto-nodo/RESULTADOS-EN.md` claims **32 B per entry with `d=1`, 1.0 B with `d=6` and 0.125 B
with `d=9`**.
