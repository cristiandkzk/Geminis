...
[English](CRITERIA.md) · **Español**

**Escritos el 21/8/2026, antes de la primera línea de `permanencia.py`.** Es la regla de la
sección 4 del `ROADMAP.es.md`, y en esta fase pesa más que en ninguna: **la única ley de control de
...
Este archivo **no se edita después de correr**. Lo que se mide va a `RESULTS.es.md`, al lado.
