...
**Corrida el 20 y 21/8/2026.** Los criterios están en `CRITERIA.es.md`, escritos antes y sin
...
cd geminis && python verificar.py    # 197 criterios, incluido que los dos lenguajes coincidan
